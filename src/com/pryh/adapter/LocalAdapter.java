...
public class LocalAdapter extends ArrayAdapter<Music>{
	private int mResourceId;
	private Context mContext;
	public LocalAdapter(Context context, int resource, List<Music> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		mViewHolder.mDele.setText(CommonUtils.toTime((int)mMusic.getTime()));
		return convertView;
	}
